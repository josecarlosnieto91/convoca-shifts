...
class CST_Admin_Turno_Editor
{
    ...
    public function render(): void
    {
        ...
        $term_actividad = $is_edit ? wp_get_post_terms($post_id, 'cst_actividad', ['fields' => 'ids']) : [];
        ...
        $all_monitores = get_users([
            'role__in' => ['administrator', 'monitor_actividad'],
            'orderby' => 'display_name',
    ...
    public function handle_save(): void
    {
        ...
        wp_set_post_terms($post_id, $actividad_term > 0 ? [$actividad_term] : [], 'cst_actividad');
        ...
        if (function_exists('cst_log_activity')) {
            ...
            cst_log_activity(get_current_user_id(), $post_id, $action_type, [
