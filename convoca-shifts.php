...
add_action( 'admin_enqueue_scripts', function ( string $hook ): void {
    wp_register_style( 'cst-estilo', CST_PLUGIN_URL . 'assets/css/estilo.css', [], CST_PLUGIN_VERSION );
    $screen = get_current_screen();
    if ( $screen && in_array( $screen->post_type, ['centro_turno'], true ) ) {
...
}, 20 ); // Priority 20 to ensure common is loaded.
